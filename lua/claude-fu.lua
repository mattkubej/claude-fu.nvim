...
function M.create_popup()
  ...
  local content_window_maps = {
    [config.keymaps.clear] = "lua require('claude-fu').clear_chat()",
    ["<Esc>"] = "lua require('claude-fu').return_to_input()",
    ["<C-[>"] = "lua require('claude-fu').return_to_input()",
    ["i"] = "lua require('claude-fu').return_to_input()",
    ["v"] = "v", -- Allow visual mode for selection
    ["V"] = "V", -- Allow visual line mode for selection
    [config.keymaps.toggle] = "lua require('claude-fu').toggle_popup()",
    -- Scrolling keymaps
    ["j"] = "j",
    ["k"] = "k",
    ["<Down>"] = "j",
  ...
  local input_window_maps = {
    [config.keymaps.clear] = "lua require('claude-fu').clear_chat()",
    ["<Esc>"] = "lua require('claude-fu').toggle_popup()",
    ["<C-[>"] = "lua require('claude-fu').toggle_popup()",
    [config.keymaps.toggle] = "lua require('claude-fu').toggle_popup()",
    -- Scrolling from input window
    ["<C-k>"] = "lua require('claude-fu').scroll_content('up')",
    ["<C-j>"] = "lua require('claude-fu').scroll_content('down')",
    ["<C-u>"] = "lua require('claude-fu').scroll_content('halfpage_up')",
    ["<C-d>"] = "lua require('claude-fu').scroll_content('halfpage_down')",
    ["<C-b>"] = "lua require('claude-fu').scroll_content('page_up')",
    ["<C-f>"] = "lua require('claude-fu').scroll_content('page_down')",
    ["<C-g><C-g>"] = "lua require('claude-fu').scroll_content('top')",
    ["<C-g>g"] = "lua require('claude-fu').scroll_content('bottom')",
    -- Focus content window for copy/selection (using Ctrl-y as it's less commonly used)
    ["<C-y>"] = "<Esc>:lua require('claude-fu').focus_content_window()<CR>",
  }
  ...
  vim.api.nvim_buf_set_keymap(
    ...
    "n",
    "<CR>",
    ":lua require('claude-fu').submit_message()<CR>",
    { noremap = true, silent = true }
  )
  ...
  vim.api.nvim_buf_set_keymap(
    ...
    "i",
    "<C-CR>",
    "<Esc>:lua require('claude-fu').submit_message()<CR>",
    { noremap = true, silent = true }
  )
